...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202011, 202010, 202009, 202008, 202007, 202005, 202004, 202003, 202002)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DTd0001", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CAd0001", "DTd0001" )
  
  DR_drifting_guantesblancos( "DRd0001", "CAd0001" )
  FE_historia_guantesblancos( "FEd0001", "DRd0001" )
  
  ###TS_strategy_guantesblancos_202109( "TSa0001", "FEa0001" )
  
  ###HT_tuning_guantesblancos( "HTa0001", "TSa0001" )
  
  # El ZZ depente de HT y TS
  ###ZZ_final_guantesblancos( "ZZa0001", c("HTa0001","TSa0001") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TSd0002", "FEd0001" )
  
  HT_tuning_guantesblancos( "HTd0002", "TSd0002" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZd0002", c("HTd0002", "TSd0002") )
